...
int main(int args, char* argv[]){
	...
	auto enc = Botan::Cipher_Mode::create("Twofish/CBC/PKCS7", Botan::Cipher_Dir::Encryption);
	auto dec = Botan::Cipher_Mode::create("Twofish/CBC/PKCS7", Botan::Cipher_Dir::Decryption);
