...
int main(int args, char* argv[]){
	...
	const size_t keyLength = Botan::BlockCipher::create("3DES")->maximum_keylength();
	...
	auto enc = Botan::Cipher_Mode::create("3DES/CBC/PKCS7", Botan::Cipher_Dir::Encryption);
	auto dec = Botan::Cipher_Mode::create("3DES/CBC/PKCS7", Botan::Cipher_Dir::Decryption);
